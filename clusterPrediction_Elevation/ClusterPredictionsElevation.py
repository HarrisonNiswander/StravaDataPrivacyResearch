...
output_path = os.path.join(script_dir, 'clusterPred_ElevationData', f'elevationAthlete{athlete}.csv')

#import athlete data
df = pd.read_csv(athlete_data_path, on_bad_lines='skip')

#obtain elevation gain
...
for fold, (train_idx, test_idx) in enumerate(skf.split(X, y)):
    ...
    for i in range(len(X_test)):
        ...
        # Add elevation features for this specific test sample
        result['elevation_gain'] = data.iloc[test_idx[i]]['elevation_gain']
